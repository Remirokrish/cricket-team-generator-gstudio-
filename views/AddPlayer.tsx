...
const AddPlayer: React.FC<AddPlayerProps> = ({ players, onAdd, onDone }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-slate-950 overflow-hidden">
      <div className="flex-1 p-4 md:p-6 max-w-lg mx-auto w-full overflow-y-auto min-h-0">
        <div className="bg-slate-900 rounded-2xl shadow-neon-blue border border-blue-500/30 p-8 relative overflow-hidden my-auto">
          ...
          <div className="flex flex-col items-center mb-8 relative">
            ...
            <h2 className="text-2xl font-bold text-white tracking-wider uppercase">NEW PLAYER</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 relative">
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-4 rounded-xl bg-slate-950 border-2 ${
                  error 
                    ? 'border-red-500/50 focus:border-red-500 focus:shadow-[0_0_10px_rgba(239,68,68,0.4)]' 
                    : success 
                    ? 'border-emerald-500/50 focus:border-emerald-500 focus:shadow-[0_0_10px_rgba(16,185,129,0.4)]'
                    : 'border-slate-700 focus:border-blue-500 focus:shadow-neon-blue'
